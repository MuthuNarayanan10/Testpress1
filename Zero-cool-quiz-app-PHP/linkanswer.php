<?php
    ...
    $_SESSION['usr1'] = $_POST['usr'];
?>

<div class="col-md-12">
        <form action="index.php?info=finish" method="post">
        <center>
                ...
                <table class="table table-bordered table-center">
                    <div class="scp-quizzes-main">
                            <div class="scp-quizzes-data">
                                <tr>
                                <th>1.what is <?php echo $_SESSION['ref_user_name'];?>'sfavourite drinks?</th></tr>
                  ...
                  <div class="scp-quizzes-main">
                            <div class="scp-quizzes-data">
                               <tr> <th>2.what is<?php echo $_SESSION['ref_user_name'];?>'s favourite Tourist place?</th></tr>
                            ...
                            <div class="scp-quizzes-main">
                            <div class="scp-quizzes-data">
                               <tr> <th>3.what is <?php echo $_SESSION['ref_user_name'];?>'s favourite hero?</th></tr>
                  ...
                  <div class="scp-quizzes-main">
                            <div class="scp-quizzes-data">
                                <tr>
                                <th>4.what is <?php echo $_SESSION['ref_user_name'];?>'s favourite Music Director?</th></tr>
                  ...
                  <div class="scp-quizzes-main">
                            <div class="scp-quizzes-data">
                                <tr>
                                <th>5.what is <?php echo $_SESSION['ref_user_name'];?>'s favourite stages of life?</th></tr>
